...
1. Skumma över [Getting Started](https://vite.dev/guide/) från Vite.
...
1. Jobba igenom övningen "[Byggverktyget Vite](/kunskap/vite)". Installera modulerna och skriv koden i `webapp-lager`.
