...
5. När formuläret skickas ska det skapas en inleverans i API:t och en redirect ska göras till inleverans listan. Utnyttja `location.hash = "nya-rutten"` för redirects.

6. Lagersaldot för produkten ska ökas med den levererade mängden.
