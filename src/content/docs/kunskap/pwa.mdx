...
En bra resurs för att förstå hur vi kan jobba med offline applikationer finns på web.dev: [Common techniques to build offline applications](https://web.dev/articles/offline-cookbook).

https://www.codemag.com/Article/2309071/Vite-and-Progressive-Web-Apps