...
import pagesAddEnv1 from "../../../assets/pages-add-env-1.png";
import pagesAddEnv2 from "../../../assets/pages-add-env-2.png";
import pagesEnableActions from "../../../assets/pages-enable-actions.png";
...
<Image src={pagesEnableActions} alt="Enable GitHub Actions for GitHub Pages source" />
...
<Image src={pagesAddEnv1} alt="Image showing Environments in GitHub" />
...
<Image src={pagesAddEnv2} alt="Image showing adding deployment branches" />
