...
Förkunskaper
-----------------------
Du har gjort uppgiften [Lager appen del 1](../uppgift/lager-appen-del-1). Du har jobbat dig igenom övningarna [Tabeller i mobila enheter](../kunskap/tabeller-i-mobila-enheter) och [Login med JWT](../kunskap/login-med-jwt).
...
1. Skapa ett formulär för att skapa en faktura utifrån en order. 

1. Ändra orderns status till 'fakturerad' enligt API:t.
