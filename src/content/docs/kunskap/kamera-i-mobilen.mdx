...
Vi installerar och importerar sedan `upload-client` längst upp i filen `components/camera.js` med först kommandot.

```shell
npm install @uploadcare/upload-client
```

Och sedan lägga till `import { UploadClient } from '@uploadcare/upload-client'` längst uppe i CameraComponent.
